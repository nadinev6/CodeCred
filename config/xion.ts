...
// Static redirect URI for consistent OAuth handling
const staticRedirectUri = 'codecred://auth';

// Log the static redirect URI for Stytch dashboard configuration
console.log('🔗 Static Redirect URI for Stytch Dashboard:', staticRedirectUri);
console.log('📋 Add this exact URI to your Stytch Dashboard at: https://stytch.com/dashboard/redirect-urls');
